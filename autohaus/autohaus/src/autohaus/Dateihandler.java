...
public abstract class Dateihandler
{
	...
	ArrayList <Auswahl> auswahlListe = new ArrayList<Auswahl>();
	String zeile;
...
//	public void writeBestellung(String filename)
//	{
//		for (Auswahl auswahl : auswahlListe)
//		{
//			try {
//				writer.write(auswahl.getModell() + );
//			} catch (IOException e) 
//			{
//				e.printStackTrace();
//			}
